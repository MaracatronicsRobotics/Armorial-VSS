...
VSSTeam* kNN::_ourTeam = NULL;
VSSTeam* kNN::_theirTeam = NULL;

QList<kNN::element> kNN::getKNN(int k, const Position &origin) {
    const QHash<quint8,VSSPlayer*> ourPlayers = _ourTeam->avPlayers();
    const QHash<quint8,VSSPlayer*> opPlayers = _theirTeam->avPlayers();
